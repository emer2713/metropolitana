    ...
    <div class="container-fluid">
        ...
        <div class="page_user">
            <form action="{{ url('/admin/user/'.$user->id.'/permissions') }}" method="POST">
                ...
                <div class="row mt16">
                    @include('admin.users.permissions.module_classifications')
                    @include('admin.users.permissions.module_subclassifications')
                    @include('admin.users.permissions.module_carousel')
                </div>

                <div class="row mt16">
                    @include('admin.users.permissions.module_beers')
                    @include('admin.users.permissions.module_foods')
                    @include('admin.users.permissions.module_promotions')

                </div>


                <div class="row mt16">
                    @include('admin.users.permissions.module_drinks')
                    @include('admin.users.permissions.module_multimedia')
                </div>
