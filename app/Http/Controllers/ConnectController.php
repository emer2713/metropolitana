...
class ConnectController extends Controller
{
    ...
    public function getLogin()
    {
        ...
        return view('autenticacion.login', compact('clasificaciones', 'subclasificaciones'));
    ...
    public function getRegister()
    {
        ...
        return view('autenticacion.register', compact('clasificaciones', 'subclasificaciones'));
    ...
    public function getRecover()
    {
        ...
        return view('autenticacion.recover', compact('clasificaciones', 'subclasificaciones'));
    ...
    public function getReset(Request $request)
    {
        ...
        $data = ['email' => $request->get('email'), 'clasificaciones' => $clasificaciones, 'subclasificaciones' => $subclasificaciones];
